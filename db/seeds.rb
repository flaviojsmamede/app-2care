...
report_category3 = ReportCategory.create(category: category3, report: report5, result: option20.name)

care_taker6 = User.create(email: "julia1@gmailcom", password: "123456", first_name: "julia", last_name: "coelho", role: "care taker")
...
report_category4 = ReportCategory.create(category: category4, report: report6, result: option20.name)

care_taker7 = User.create(email: "julia2@gmailcom", password: "123456", first_name: "julia", last_name: "coelho", role: "care taker")
...
report_category5 = ReportCategory.create(category: category5, report: report7, result: option20.name)

care_taker8 = User.create(email: "julia3@gmailcom", password: "123456", first_name: "julia", last_name: "coelho", role: "care taker")
...
report_category6 = ReportCategory.create(category: category6, report: report8, result: option20.name)

care_taker9 = User.create(email: "julia4@gmailcom", password: "123456", first_name: "julia", last_name: "coelho", role: "care taker")
...
report_category7 = ReportCategory.create(category: category7, report: report9, result: option20.name)

care_taker10 = User.create(email: "julia5@gmailcom", password: "123456", first_name: "julia", last_name: "coelho", role: "care taker")
...
report_category8 = ReportCategory.create(category: category7, report: report10, result: option20.name)

care_taker11 = User.create(email: "julia6@gmailcom", password: "123456", first_name: "julia", last_name: "coelho", role: "care taker")
...
report_category9 = ReportCategory.create(category: category4, report: report11, result: option20.name)

care_taker12 = User.create(email: "julia7@gmailcom", password: "123456", first_name: "julia", last_name: "coelho", role: "care taker")
...
report_category10 = ReportCategory.create(category: category6, report: report12, result: option20.name)
